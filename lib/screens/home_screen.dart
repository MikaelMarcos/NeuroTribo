...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildLatestContentSection() {
    return Padding(
      padding: const EdgeInsets.symmetric(horizontal: 20),
      child: Row(
  ...
  Widget _buildVideoCarousel() {
    return SizedBox(
      ...
      child: ListView(
        ...
        children: [
          _buildVideoCard("Neuroplasticidade", "Aula 1", "https://assets.mixkit.co/videos/preview/mixkit-waves-in-the-water-1164-large.mp4"),
          _buildVideoCard("Dopamina Detox", "Aula 2", "https://assets.mixkit.co/videos/preview/mixkit-tree-with-yellow-flowers-1173-large.mp4"),
          _buildVideoCard("Rotina Matinal", "Extra", "https://assets.mixkit.co/videos/preview/mixkit-stars-in-space-1610-large.mp4"),
        ],
      ),
    );
  }
  ...
  Widget _buildVideoCard(String title, String subtitle, String videoUrl) {
    return GestureDetector(
      onTap: () {
        Navigator.push(context, MaterialPageRoute(
          builder: (context) => VideoDetailScreen(title: title, videoUrl: videoUrl)
        ));
      },
      child: Container(
        width: 160,
                          ...
                          child: ElevatedButton.icon(
                            onPressed: () {
                              ScaffoldMessenger.of(context).showSnackBar(
                                const SnackBar(content: Text("Baixando material..."))
                              );
                            },
